...
class ExpectMap<K, V>(subject: Map<K, V>?, flavor: Flavor) : ExpectAny<Map<K, V>>(subject, flavor) {
    ...
    override val have: ExpectMap<K, V>
        get() {
            words.add("have")
            haveMode = true
            return this
    ...
    override val to: ExpectMap<K, V>
        get() {
            super.to
            return this
        }

    override val be: ExpectMap<K, V>
        get() {
            super.be
            return this
        }

    override val been: ExpectMap<K, V>
        get() {
            super.been
            return this
        }

    override val that: ExpectMap<K, V>
        get() {
            super.that
            return this
        }

    override val which: ExpectMap<K, V>
        get() {
            super.which
            return this
        }

    override val and: ExpectMap<K, V>
        get() {
            super.and
            return this
        }

    override val has: ExpectMap<K, V>
        get() {
            super.has
            return this
        }

    override val with: ExpectMap<K, V>
        get() {
            super.with
            return this
        }

    override val at: ExpectMap<K, V>
        get() {
            super.at
            return this
        }

    override val a: ExpectMap<K, V>
        get() {
            super.a
            return this
        }

    override val an: ExpectMap<K, V>
        get() {
            super.an
            return this
        }

    override val of: ExpectMap<K, V>
        get() {
            super.of
            return this
        }

    override val same: ExpectMap<K, V>
        get() {
            super.same
            return this
        }

    override val the: ExpectMap<K, V>
        get() {
            super.the
            return this
        }

    override val `is`: ExpectMap<K, V>
        get() {
            super.`is`
            return this
        }

    override val not: ExpectMap<K, V>
        get() {
            super.not
            return this
        }

    override val `null`: ExpectMap<K, V>
        get() {
            super.`null`
            return this
        }
