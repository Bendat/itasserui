...
class ExpectDouble(subject: Double?, flavor: Flavor) : ExpectComparable<Double>(subject, flavor) {
    ...
    override val to: ExpectDouble
        get() {
            super.to
            return this
        }

    override val be: ExpectDouble
        get() {
            super.be
            return this
        }

    override val been: ExpectDouble
        get() {
            super.been
            return this
        }

    override val that: ExpectDouble
        get() {
            super.that
            return this
        }

    override val which: ExpectDouble
        get() {
            super.which
            return this
        }

    override val and: ExpectDouble
        get() {
            super.and
            return this
        }

    override val has: ExpectDouble
        get() {
            super.has
            return this
        }

    override val have: ExpectDouble
        get() {
            super.have
            return this
        }

    override val with: ExpectDouble
        get() {
            super.with
            return this
        }

    override val at: ExpectDouble
        get() {
            super.at
            return this
        }

    override val a: ExpectDouble
        get() {
            super.a
            return this
        }

    override val an: ExpectDouble
        get() {
            super.an
            return this
        }

    override val of: ExpectDouble
        get() {
            super.of
            return this
        }

    override val same: ExpectDouble
        get() {
            super.same
            return this
        }

    override val the: ExpectDouble
        get() {
            super.the
            return this
        }

    override val `is`: ExpectDouble
        get() {
            super.`is`
            return this
        }

    override val not: ExpectDouble
        get() {
            super.not
            return this
        }

    override val `null`: ExpectDouble
        get() {
            super.`null`
            return this
        }
